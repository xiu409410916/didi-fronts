			...
			<view class="box-view">
				...
				<view class="meHead">
					<view class="meHeadAvatar">
						<image :src="doctorInfo.avatarUrl" mode="aspectFill"></image>
					</view>
				...
				<view class="con">
					<view class="vi" @click="setPassword" v-if="!isSetPassword">
						<view class="left">
							<image src="../../static/password.png"></image>设置支付密码
						</view>
						<view class="right">
					...
					<view class="vi" @click="resetPassword" v-if="isSetPassword">
						<view class="left">
							<image src="../../static/password.png"></image>重置支付密码
						</view>
						<view class="right">
							<image src="../../static/you.png"></image>
						</view>
					...
					<view class="vi" @click="toAgent">
						<view class="left">
							<image src="../../static/agent.png"></image>成为代理商
						</view>
						<view class="right">
							<image src="../../static/you.png"></image>
						</view>
					...
					<view class="vi" @click="toQrCode">
						<view class="left">
							<image src="../../static/qrcode.png"></image>我的二维码
						</view>
						<view class="right">
							<image src="../../static/you.png"></image>
						</view>
